...
export class BookSelection extends Component<BookSelectionProps, BookSelectionState> {  
    ...
    constructor(props: BookSelectionProps) {  
        ...
        this.allBooks = [  
            ...
            { title: 'TarkaSangraha - English Translation', author: 'Yash Khasbage', indent: 'ml-6' }
        ];  
        this.state = {  
    ...
    render() {  
        return (  
            <Box className="flex flex-col h-screen justify-start space-y-6 my-8 max-w-3xl mx-auto">  
