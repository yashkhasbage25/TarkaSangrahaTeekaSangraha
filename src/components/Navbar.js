        ...
        <div className="collapse navbar-collapse" id="navbarNav">  
            <ul className="navbar-nav ml-auto">  
                <li className="nav-item dropdown">  
                    <a className="nav-link dropdown-toggle" href="#" id="pratyaksha-nav-dropdown" role="button" data-toggle="dropdown"  
                ...
                <li className="nav-item dropdown">  
                    <a className="nav-link dropdown-toggle" href="#" id="anumana-nav-dropdown" role="button" data-toggle="dropdown"  
                ...
                <li className="nav-item dropdown">  
                    <a className="nav-link dropdown-toggle" href="#" id="upamana-nav-dropdown" role="button" data-toggle="dropdown"  
                ...
                <li className="nav-item dropdown">  
                    <a className="nav-link dropdown-toggle" href="#" id="shabda-nav-dropdown" role="button" data-toggle="dropdown"  
                ...
                <li className="nav-item dropdown">  
                    <a className="nav-link dropdown-toggle" href="#" id="teeka-nav-dropdown" role="button" data-toggle="dropdown"  
                       aria-haspopup="true" aria-expanded="false">टीकाचयनम्</a>  
                    <div className="dropdown-menu" aria-labelledby="teeka-nav-dropdown">  
                        <div className="dropdown-item">  
                            <input className="form-check-input" type="checkbox" value="" id="padakrtyam-checkbox" defaultChecked />  
                            <label className="form-check-label">पदकृत्यम्</label>  
                        </div>  
                        <div className="dropdown-item">  
                            <input className="form-check-input" type="checkbox" value="" id="nyayabodhini-checkbox" defaultChecked />  
                            <label className="form-check-label">न्यायबोधिनी</label>  
                        </div>  
                        <div className="dropdown-item">  
                            <input className="form-check-input" type="checkbox" value="" id="deepika-checkbox" defaultChecked />  
                            <label className="form-check-label">दीपिका</label>  
                        </div>  
                    </div>  
                </li>  
            </ul>  
